<?php
function feature_products_gallery_admin_init(){
	add_meta_box(
		'feature_products_gallery_metabox_id',
		'Gallery',
		'feature_products_gallery_metabox_callback',
		'featured_products', // Change post type name
		'normal',
		'core'
	);
}
add_action( 'admin_init', 'feature_products_gallery_admin_init' );

function feature_products_gallery_metabox_callback(){
...
function feature_products_gallery_metabox_styles_scripts(){
    global $post;
    if( 'featured_products' != $post->post_type )
        return;
    ?>  
    <style type="text/css">
	.gallery_area {
...
add_action( 'admin_head-post.php', 'feature_products_gallery_metabox_styles_scripts' );
add_action( 'admin_head-post-new.php', 'feature_products_gallery_metabox_styles_scripts' );


function feature_products_gallery_save( $post_id ) {
    ...
    // Correct post type
    if ( 'ett_gallery' != $_POST['post_type'] ) // here you can set the post type name
        return;
...
add_action( 'save_post', 'feature_products_gallery_save' );
